...
// Source: proto/mailbox_proto/mailbox_grpc.pb.go

// Package mock_mailbox_proto is a generated GoMock package.
...
func (m *MockMailboxClient) CountUnread(ctx context.Context, in *CountUnreadRequest, opts ...grpc.CallOption) (*ResponseCountUnread, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMailboxClientMockRecorder) CountUnread(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountUnread", reflect.TypeOf((*MockMailboxClient)(nil).CountUnread), varargs...)
}
...
func (m *MockMailboxClient) SendMail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*utils_proto.JsonExtendResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*utils_proto.JsonExtendResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// CountUnread mocks base method.
func (m *MockMailboxServer) CountUnread(arg0 context.Context, arg1 *CountUnreadRequest) (*ResponseCountUnread, error) {
	m.ctrl.T.Helper()
...
// CountUnread indicates an expected call of CountUnread.
func (mr *MockMailboxServerMockRecorder) CountUnread(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountUnread", reflect.TypeOf((*MockMailboxServer)(nil).CountUnread), arg0, arg1)
}
...
// SendMail mocks base method.
func (m *MockMailboxServer) SendMail(arg0 context.Context, arg1 *SendMailRequest) (*utils_proto.JsonExtendResponse, error) {
	m.ctrl.T.Helper()
